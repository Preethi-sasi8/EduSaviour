# ═══════════════════════════════════════════════════════════════
# page_predict.py — Student Form + Prediction Results
# ═══════════════════════════════════════════════════════════════
...
def show():
    ...
    top_left, top_mid, top_right1, top_right2 = st.columns([6, 1, 1, 1])
...
def _show_results():
    ...
    # Action buttons for Moderate and High
    if risk in ["Moderate", "High"]:
        ...
        with col2:
            if st.button("✉️ Send Message to Parents (Tamil)", use_container_width=True):
                ...
                st.rerun()
        with col3:
           if st.button("🧑‍⚕️ Give Counselling"):
